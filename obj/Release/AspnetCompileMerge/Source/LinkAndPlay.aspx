...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div style="width: 70%; position:absolute; left: 15%; top: 2%; justify-content;">
        <asp:Table runat="server">
            ...
            <asp:TableRow runat="server">
                <asp:TableCell ColumnSpan="2" runat="server">
                    <img id="linkAndPlayImg2" onmouseover="zoomImg(true, 'linkAndPlayImg2', 10);" onmouseout="zoomImg(false, 'linkAndPlayImg1', 10);" src="/img/LinkAndPlay/animatorControllerIcon.png" style="width: 100%; position: relative; left: 0%;" />
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow runat="server">
                <asp:TableCell runat="server" ColumnSpan="2">
            ...
            <asp:TableRow runat="server">
                <asp:TableCell runat="server" ColumnSpan="2">
                    <p id="linkAndPlay10" runat="server">
                        В методе <code>jump()</code> проверяется, если была нажата клавиша ‘пробел’ и персонаж не находится в прыжке, тогда запускается анимация прыжка, а все остальные анимации останавливаются.
                    </p>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow runat="server">
